/**
 * Func332 implementation SEC code representation.
 *
...
object SECTree {
     ...
     * the named argument. If the optional function name is defined, it
     * will be bound to the closure in the captured environment so that
     * recursive calls are possible.
     */
    case class IClosure (optFunName : Option[Name], argName : Name, body : Frame) extends Instr
